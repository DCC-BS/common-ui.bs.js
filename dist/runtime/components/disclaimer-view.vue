...
<style scoped>
.disclaimer-content{margin:auto;max-width:800px;padding:1rem}h2{font-size:1.5rem;margin-bottom:1rem}h3{font-size:1.25rem;margin-top:1.5rem}.postfix{padding-top:1rem}.confirmation{padding:2rem}.confirmation-checkbox{align-items:center;display:flex;gap:1rem;justify-items:stretch}.confirmation input{height:25px;width:25px}
</style>
