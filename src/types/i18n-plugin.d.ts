...
import type { LocaleObject } from "../../node_modules/@nuxtjs/i18n/dist/types.d.mts";
...
declare module "vue-i18n" {
    ...
    interface ExportedGlobalComposer
        extends ComposerCustomProperties<LocaleObject[]> {}
...
declare module "vue-router" {
    ...
    > = Name | (Omit<RouteLocationAsRelativeI18n, "path"> & { path?: string });
    /**
    ...
    > = RouteMapGeneric extends RouteMapI18n
        ...
        :
              | _LiteralUnion<
                    RouteLocationAsStringTypedList<RouteMapI18n>[Name],
                    string
                >
    ...
    export type RouteLocationNormalizedLoadedTypedListI18n<
        RouteMapOriginal extends RouteMapGeneric = RouteMapGeneric,
    > = {
    ...
    type _LiteralUnion<LiteralType, BaseType extends string = string> =
        | LiteralType
    ...
    > = RouteMapGeneric extends RouteMapI18n
        ? RouteLocationAsPathGeneric
        : RouteLocationAsPathTypedList<RouteMapI18n>[Name];
